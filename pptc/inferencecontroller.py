...
from graph.jointree import JoinTreeListener
from pptc.initializer import Initializer
from pptc.moralizer import Moralizer
from pptc.potentialinitializer import PotentialInitializer
from pptc.propagator import Propagator
from pptc.transformer import Transformer
from pptc.triangulator import Triangulator
...
class InferenceController(JoinTreeListener):
    ...
    def apply(bbn):
        ...
        Initializer.initialize(join_tree) # set size and scope of cliques 
